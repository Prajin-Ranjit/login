...
const Registration = ({registrationState, setRegistrationState}) => {
  return (
    <div className={`w-full h-full px-10 absolute right-0 flex flex-col items-center justify-center transition-all duration-700 ease-in-out ${registrationState ? 'delay-300 translate-x-0 opacity-100' : 'translate-x-full opacity-0'}`}>
