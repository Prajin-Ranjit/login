...
const SignIn = ({registrationState, setRegistrationState}) => {
  return (
    <div className={`w-full h-full px-3 sm:px-6 lg:px-10 absolute right-0 flex flex-col items-center justify-center transition-all duration-700 ease-in-out ${registrationState ? 'opacity-0 translate-x-full' : 'delay-300 translate-x-0 opacity-100'}`}>
      ...
      <form action="" className="w-full">
        <Input id="email" label="Email" placeholder="email sign" type="email" />
        <Input
          id="password"
          label="Password"
